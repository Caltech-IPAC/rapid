...
# RML note - 21 August 2018, needed to fix indentations for
#running in python 3.0 and fixing parens
#had to also add another slash to line s65 to make half an int
############################################################
...
def py_zogy(Nf, Rf, P_Nf, P_Rf, S_Nf, S_Rf, SN, SR, dx=0.25, dy=0.25):
	...
	idx0 = slice(N.shape[0]//2 - P_N_small.shape[0]//2, N.shape[0]//2 + P_N_small.shape[0]//2 + 1)
	idx1 = slice(N.shape[1]//2 - P_N_small.shape[1]//2, N.shape[1]//2 + P_N_small.shape[1]//2 + 1)
