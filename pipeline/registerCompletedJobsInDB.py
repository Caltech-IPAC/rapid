...
def run_single_core_job(dbh,jid,log_fname):

    print("\nStart of run_single_core_job: jid, log_fname =",jid,log_fname)
...
def execute_parallel_processes(dbh,jids,log_filenames,num_cores=None):
    ...
    with ProcessPoolExecutor(max_workers=num_cores) as executor:
        ...
        futures = [executor.submit(run_single_core_job,dbh,jid,log_fname) for jid,log_fname in zip(jids,log_filenames)]
