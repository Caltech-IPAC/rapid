...
if __name__ == '__main__':
    ...
    with open(config_output_filename, 'w') as config_outputfile:
        ...
        config_comments = []
        config_comment.append("#")
        config_comment.append("# " + config_output_s3_bucket_destname)
        config_comment.append("#")
        config_comment.append("# " + proc_utc_datetime)
        config_comment.append("#")
        config_comment.append("# Machine-generated by " + swname)
        config_comment.append("#")
        config_comment.append("")
