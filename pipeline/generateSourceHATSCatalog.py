...
Here is an example sources database record:
    ...
    sid    |  id  |  pid   |         ra         |         dec         |   xfit   |   yfit   |  fluxfit   |  xerr  |  yerr  | fluxerr  | npixfit |   qfit   |  cfit  | flags | sharpness | roundness1  |  roundness2  | npix |   peak    |  field  |  hp6  |   hp9   | expid | fid | sca |      mjdobs       | isdiffpos |  redchi
-----------+------+--------+--------------------+---------------------+----------+----------+------------+--------+--------+----------+---------+----------+--------+-------+-----------+-------------+--------------+------+-----------+---------+-------+---------+-------+-----+-----+-------------------+-----------+-----------
 293228909 | 1830 | 328539 | 268.52830287805165 | -29.281683816567625 | 4079.404 | 246.1036 | -266.80896 | 0.0724 | 0.0976 | 19.74822 |     238 | -26.4206 | 0.0811 |     5 |  0.888383 | -0.22417465 | -0.116634116 |   25 | 129.58977 | 4686833 | 28823 | 1844709 | 75740 |   4 |   2 | 61514.91410272289 | t         | 235.99634
(1 row)
'''
