...
def get_visit_id_dict():
    ...
    with open(schedule_file, mode='r', newline='') as file:
        ...
        for row in reader:
            ...
            visit_id_dict[row["visit-id"]].append(pa)
...
def parse_pid_file(input_file,visit_id_dict):
    ...
    for row in survey_qtable:
        ...
        try:
            ...
            pas.append(visit_jds[2])
            visit_id_list.append(visit_jds[3])
    ...
    return ra,dec,pas,start_jd_obs,end_jd_obs,durations,bandpasses,pids,visit_id_list,exposure_times



def consolidate_surveys_in_schedule(ra1,dec1,pas1,visit_start_jd_obs1,visit_end_jd_obs1,durations1,bandpasses1,pids1,visits1,exposure_times1,
                                    ra2,dec2,pas2,visit_start_jd_obs2,visit_end_jd_obs2,durations2,bandpasses2,pids2,visits2,exposure_times2,
                                    ra3,dec3,pas3,visit_start_jd_obs3,visit_end_jd_obs3,durations3,bandpasses3,pids3,visits3,exposure_times3,
                                    ra4,dec4,pas4,visit_start_jd_obs4,visit_end_jd_obs4,durations4,bandpasses4,pids4,visits4,exposure_times4):
    visit_start_jds = []
    visit_end_jds = []
    durations = []
    ras = []
    ...
    for ra,dec,pa,visit_start_jd_obs,visit_end_jd_obs,duration,bandpass,pid,visit,exposure_time in zip(ra1,
                                                                                                       dec1,
                                                                                                       pas1,
                                                                                                       visit_start_jd_obs1,
                                                                                                       visit_end_jd_obs1,
    ...
    for ra,dec,pa,visit_start_jd_obs,visit_end_jd_obs,duration,bandpass,pid,visit,exposure_time in zip(ra2,
                                                                                                       dec2,
                                                                                                       pas2,
                                                                                                       visit_start_jd_obs2,
                                                                                                       visit_end_jd_obs2,
    ...
    for ra,dec,pa,visit_start_jd_obs,visit_end_jd_obs,duration,bandpass,pid,visit,exposure_time in zip(ra3,
                                                                                                       dec3,
                                                                                                       pas3,
                                                                                                       visit_start_jd_obs3,
                                                                                                       visit_end_jd_obs3,
    ...
    for ra,dec,pa,visit_start_jd_obs,visit_end_jd_obs,duration,bandpass,pid,visit,exposure_time in zip(ra4,
                                                                                                       dec4,
                                                                                                       pas4,
                                                                                                       visit_start_jd_obs4,
                                                                                                       visit_end_jd_obs4,
    ...
    sr = ["index","visit_id","pid","survey","ra","dec","orient","visit_start_jd","visit_end_jd",
    ...
    for i in range(len(ras)):
        ...
        if exposure_end_obs_jd >= visit_end_jd:
            ...
            j += 1
            sr = [j,visit,pid,survey,ra,dec,pa,visit_start_jd,visit_end_jd,
...
if __name__ == '__main__':
    ...
    ra1,dec1,pas1,start_jd_obs1,end_jd_obs1,durations1,bandpasses1,pids1,visits1,exposure_times1 = \
        parse_pid_file(input_files[0],visit_id_dict)
    ra2,dec2,pas2,start_jd_obs2,end_jd_obs2,durations2,bandpasses2,pids2,visits2,exposure_times2 = \
        parse_pid_file(input_files[1],visit_id_dict)
    ra3,dec3,pas3,start_jd_obs3,end_jd_obs3,durations3,bandpasses3,pids3,visits3,exposure_times3 = \
        parse_pid_file(input_files[2],visit_id_dict)
    ra4,dec4,pas4,start_jd_obs4,end_jd_obs4,durations4,bandpasses4,pids4,visits4,exposure_times4 = \
    ...
    consolidate_surveys_in_schedule(ra1,dec1,pas1,start_jd_obs1,end_jd_obs1,durations1,bandpasses1,pids1,visits1,exposure_times1,
                                    ra2,dec2,pas2,start_jd_obs2,end_jd_obs2,durations2,bandpasses2,pids2,visits2,exposure_times2,
                                    ra3,dec3,pas3,start_jd_obs3,end_jd_obs3,durations3,bandpasses3,pids3,visits3,exposure_times3,
                                    ra4,dec4,pas4,start_jd_obs4,end_jd_obs4,durations4,bandpasses4,pids4,visits4,exposure_times4)
