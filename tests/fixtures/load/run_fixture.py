...
copy under ``rapidpipe/selftest/fixtures/load/`` -- this directory holds
...
from rapidpipe.selftest.load import FIXTURE  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"stage-load: database=fake "
