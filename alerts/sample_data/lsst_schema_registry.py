...
schema = packet.SchemaRegistry.from_filesystem(
    root="schemas",
    schema_root="rapid.v01_00"
).get_by_version("01.00")

with open("rapid_v01_00_alert.avro", "wb") as f:
    schema.store_alerts(f, [json_data_combined])

with open("rapid_v01_00_alert.avro", "rb") as file:
