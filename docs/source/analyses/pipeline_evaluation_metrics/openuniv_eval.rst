...
for two difference image-subtraction methods: ZOGY and SFFT (with PSF cross-convolution). 
...
where available (Scorr for ZOGY and cross-convolved difference images for SFFT).
...
====================================
We evaluate the Figure of Merit (FOM; as defined in :ref:`figure_of_merit`) for both difference imaging methods for H158. We define two 
...
.. note::
   ...
   based on the FOM. The chosen thresholds, weights, and grouping criteria that will be used for, e.g., algorithm down-selection, 
