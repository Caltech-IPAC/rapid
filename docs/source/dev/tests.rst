...
Test to process 4858 exposure-SCAs, all in the observation date/time ranges given below, making
...
This test generated 3884 new reference images, for 5 different filters and a variety of fields.  The number of fields
for each of the filter IDs included is listed as follows:
